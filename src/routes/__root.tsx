  ...
  head: () => ({
    meta: [
      ...
      { title: "Spotlite: Your money, finally understood" },
      {
        name: "description",
        content:
          "Spotlite is an agentic financial intelligence layer for SBI. Find the money you're leaving on the table.",
      },
      { name: "author", content: "Spotlite" },
      { property: "og:title", content: "Spotlite: Your money, finally understood" },
      {
      ...
      { name: "theme-color", content: "#1F2A7A" },
    ],
    links: [
