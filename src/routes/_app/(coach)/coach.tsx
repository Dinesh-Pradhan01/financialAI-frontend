...
import { answerForQuestion, coachSuggestions, type CoachAnswer } from "@/shared/data/rohan";
import { CoachAnswerCard } from "@/features/coach/components/coach-answer";
import { useAppDispatch, useAppSelector } from "@/shared/store";
import { selectConversation } from "@/shared/store/selectors";
import { addMessage, clearConversation } from "@/shared/store/slices/coachSlice";
import { useAuth } from "@/shared/contexts/AuthContext";

export const Route = createFileRoute("/_app/(coach)/coach")({
  head: () => ({
    meta: [
