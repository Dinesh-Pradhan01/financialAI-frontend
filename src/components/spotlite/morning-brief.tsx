  ...
  return (
    <header className="relative overflow-hidden bg-brand px-5 pb-9 pt-10 text-on-brand md:rounded-bl-3xl md:px-10">
      <div className="flex items-start justify-between">
        <div>
          <p className="font-display text-2xl font-bold leading-tight">Good morning, {name}</p>
          <p className="mt-1 text-sm opacity-80">Last night, Spotlite analyzed your money.</p>
        </div>
