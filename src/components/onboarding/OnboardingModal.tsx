      ...
      try {
        ...
        if (res && isMounted) {
          ...
          if (res.leadership_info) {
            ...
            if (l.primary_product_service)
              setPrimaryProductService(l.primary_product_service);
        ...
        console.log("No previous onboarding draft found:", err);
      } finally {
        if (isMounted) {
