          ...
          <div className="rounded-xl border border-border-c bg-surface p-5 shadow-xs space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 pt-1">
              ...
              <FormField
                ...
                onChange={(e) => state.setCeoPhone(e.target.value)}
          ...
          <div className="rounded-xl border border-border-c bg-surface p-5 shadow-xs space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 pt-1">
              ...
              <FormField
                ...
                onChange={(e) => state.setCfoPhone(e.target.value)}
              ...
              <FormField
                ...
                onChange={(e) => state.setCfoDesignation(e.target.value)}
          ...
          <div className="rounded-xl border border-border-c bg-surface p-5 shadow-xs space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 pt-1">
              ...
              <FormField
                ...
                type="tel"
                value={state.hrPhone}
                onChange={(e) => state.setHrPhone(e.target.value)}
              ...
              <FormField
                ...
                onChange={(e) => state.setHrDesignation(e.target.value)}
        ...
        <div className="rounded-xl border border-border-c bg-surface p-5 shadow-xs space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4 pt-1">
            ...
            <FormSelect
              ...
              onValueChange={(val) => state.setNumberOfEmployees(val)}
            ...
            <FormField
              ...
              onChange={(e) => state.setNumberOfBranches(e.target.value)}
              placeholder="1"
            />
            ...
            <FormSelect
              ...
              onValueChange={(val) => state.setBusinessModel(val)}
            ...
            <FormField
              ...
              onChange={(e) => state.setPrimaryProductService(e.target.value)}
            ...
            <div className="md:col-span-2">
              <FormTextarea
                ...
                onChange={(e) => state.setBusinessDescription(e.target.value)}
