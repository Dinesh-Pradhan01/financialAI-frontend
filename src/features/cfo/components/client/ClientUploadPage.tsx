...
import { setClientStep, resetClient } from "@/shared/store/slices/cfoSlice";
import { ClientUploadDropzone } from "./ClientUploadDropzone";
import { ClientPreviewStep } from "./ClientPreviewStep";
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="font-display text-2xl font-bold tracking-tight text-foreground">
            Upload Client Portfolio
          </h1>
          <p className="text-text-secondary mt-0.5 text-xs sm:text-sm leading-relaxed">
            Import your client master data, revenue agreements, and billing parameters via Excel or manual entry.
          </p>
        </div>
      </div>
