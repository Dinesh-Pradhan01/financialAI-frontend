...
import { setClientFocusedRow } from "@/shared/store/slices/cfoSlice";
import type { ClientValidationIssue } from "../../types/client";

export function ClientValidationPanel({ issues }: { issues: ClientValidationIssue[] }) {
