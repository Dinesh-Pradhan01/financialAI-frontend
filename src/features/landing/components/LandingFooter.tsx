...
export function LandingFooter() {
  return (
    <footer className="bg-[#050c1b] text-slate-400">
      <div className="mx-auto grid max-w-7xl 2xl:max-w-360 gap-10 lg:gap-14 px-4 py-16 lg:py-20 sm:px-6 lg:grid-cols-5 lg:px-8 2xl:px-12">
        <div className="lg:col-span-2">
          ...
          <p className="mt-4 max-w-md text-sm sm:text-base leading-relaxed text-slate-400">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl 2xl:max-w-360 flex-col gap-4 px-4 py-6 text-xs sm:text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8 2xl:px-12">
