...
import { UploadCloud, FileSpreadsheet, Loader2, AlertTriangle, FileX } from "lucide-react";
import { cn } from "@/shared/lib/utils";
import { useEmployeeUpload } from "../../hooks/useEmployee";
import { useAppDispatch, useAppSelector } from "@/shared/store";
import { setEmployeePreview, setEmployeeStep, discardEmployeePreview } from "@/shared/store/slices/hrSlice";
...
export function EmployeeUploadDropzone() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <h3 className="text-xl font-bold text-foreground">Drop your Excel file here</h3>
      ...
      <Dialog open={!!invalidTemplate} onOpenChange={() => setInvalidTemplate(null)}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter className="sm:justify-between">
            <button
              onClick={() => {
                // In real app, trigger template download
